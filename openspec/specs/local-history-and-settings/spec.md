...
- **THEN** срок хранения равен 30 дням, file limit равен проверенному hard limit, custom destination отсутствует, автоприём выключен, а автоостановка равна 30 минутам
